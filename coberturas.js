  ...
  chart = new Chart(document.getElementById('main-chart'), {
    ...
    options: {
      ...
      plugins: {
        ...
        legend: { labels: { font: { family: 'DM Sans', size: 12 }, usePointStyle: true, pointStyle: 'line' } }
      },
      scales: {
        x: {
          title: { display: true, text: 'Precio a Vencimiento (u$s)', font: { family: 'DM Sans', size: 12, weight: '600' }, color: '#505845' },
          grid: { color: 'rgba(0,0,0,.05)' },
          ticks: { font: { family: 'JetBrains Mono', size: 10 }, color: '#7e8574' }
        },
        y: {
          title: { display: true, text: 'Precio Neto de Venta (u$s)', font: { family: 'DM Sans', size: 12, weight: '600' }, color: '#505845' },
          grid: { color: 'rgba(0,0,0,.05)' },
          ticks: { font: { family: 'JetBrains Mono', size: 10 }, color: '#7e8574' }
        }
      }
